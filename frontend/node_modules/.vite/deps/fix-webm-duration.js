...
//#region ../node_modules/fix-webm-duration/fix-webm-duration.js
var require_fix_webm_duration = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(name, definition) {
		...
		WebmFile.prototype.fixDuration = function(duration, options) {
			...
			if (logger === void 0) logger = function(message) {
				console.log(message);
			};
			else if (!logger) logger = function() {};
...
//#endregion
export default require_fix_webm_duration();

//# sourceMappingURL=fix-webm-duration.js.map